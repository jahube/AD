...
$remoteMBXs = Get-ADUser -LDAPFilter "(msExchRemoteRecipientType=*)" -Properties UserPrincipalName,DistinguishedName,ObjectGuid,mail,mailnickname,proxyaddresses,msExchRemoteRecipientType,Targetaddress
