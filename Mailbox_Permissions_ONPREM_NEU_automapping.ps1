...
$USERTYPE = "Unknown"
            ...
            $item | Add-Member -MemberType NoteProperty -Name "AccessRights" -Value $($p.accessrights).ToString() # $P.AccessRights ($p.accessrights |out-string).Trim()
            $item | Add-Member -MemberType NoteProperty -Name "InheritanceType" -Value $P.InheritanceType
